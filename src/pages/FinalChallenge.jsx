...
const FinalChallenge = () => {
  return (
    <div className='container'>
      ...
      <p>Here's the source code: <a href="https://github.com/shashwatvegeta/StorymodeGame" target="_blank" rel="noopener noreferrer" className='source-link'>GitHub Link</a></p>
